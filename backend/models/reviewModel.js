...
const reviewSchema = new mongoose.Schema({
    ...
    isVerified: {
        type: Boolean,
        default: true, // Since reviews can only be made after completed appointments
    }
}, { minimize: false });
